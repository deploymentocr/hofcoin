...
uint256 hashGenesisBlock("0x1d922fea4511d9c8ea46ecc23a8f28bd55e77fbf667e5719ffa169d1f1448877");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // hofcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "hofcoin Signed Message:\n";
...
{
    // hofcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // hofcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // hofcoin: 3.5 days
static const int64 nTargetSpacing = 150; // hofcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // hofcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // hofcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // hofcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x76980ca63874b29e38f5d73a26144f05e77943c372346ad5c629b2e0a1684134");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Beating Tarichecoin since 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 500000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("fb133ece279389f6e048e88c9eeecaf07a6d9f95d258e069dfe77f0d802a1f3d8c7dbb843fd7bfbb05feecad9f0659f813b832ffb242a60041ffbf65843a1a0ad1") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1456559803;
        block.nBits    = 504365644;
        block.nNonce   = 989368498;

        if (fTestNet)
        {
            block.nTime    = 1456559803;
            block.nNonce   = 2639277147;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6706f14ab27a09fa9c5859cd1162387712dc8831c708d60225bc0a9fb39396dd"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // hofcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("hofcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("hofcoinMiner : ProcessBlock, block not accepted");
    }
